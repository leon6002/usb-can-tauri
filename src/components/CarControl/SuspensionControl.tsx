    ...
    <div className="flex flex-col gap-1 w-full h-full bg-black/20 p-1.5 rounded-lg backdrop-blur-sm">
      ...
      <div className="flex gap-1 w-full">
        <button
          ...
          className={`flex-1 px-2 py-2 text-xs rounded-lg font-medium transition-all duration-200 border ${suspensionStatus === "升高"
        ...
        <button
          ...
          disabled={!isConnected || suspensionStatus === "升高" || suspensionStatus === "降低" || isDriving}
          className={`flex-1 px-2 py-1 text-xs rounded-lg font-medium transition-all duration-200 border ${suspensionStatus === "降低"
            ? "bg-blue-500/80 border-blue-400/50 text-white shadow-[0_0_10px_rgba(59,130,246,0.4)]"
